...
<body>
   ...
   <main class="main-container">
      ...
      <section class="parent">
         <a href="videos.php" id="videos">Vídeos</a>

         <a href="hoteis.php" id="hoteis">Hotéis</a>

         <a href="mapa_turistico.php" id="mapa-turistico">Mapa Turisístico Animado</a>

         <a href="barraca_do_pescador.php" id="barraca-pescador">Barraca do Pescador</a>
         ...
         <a href="igarapes.php" id="igarapes">Igarapés</a>

         <a href="tabua_de_mare.php" id="tabua-de-mare">Tábua de Maré</a>

         <a href="cat.php" id="cat">Centro de Atendimento ao Turista</a>

         <a href="praias.php" id="praias">Praias</a>

         <a href="contatos_uteis.php" id="contatos-uteis">Contatos Úteis</a>
      </section>
   </main>
