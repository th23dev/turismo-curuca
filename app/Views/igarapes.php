...
$lugares = $controller->buscarLugares('igarape');
?>
            ...
            <?php if ($lugares > 0): ?>
               <?php foreach ($lugares as $lugar): ?>
                  <div class="card" onclick="openModal('hotel-<?php echo $lugar['id']; ?>')">
                     ...
                     <?php else: ?>
                        <div class="card-image-placeholder"><i class="fas fa-water"></i></div>
                     <?php endif; ?>
                     <h3><?php echo $lugar['nome']; ?></h3>
                  </div>
               <?php endforeach; ?>
            <?php else: ?>
               <p style="padding:20px;">Nenhum igarapé encontrado para "<strong><?php echo htmlspecialchars($search ?: 'nenhum termo'); ?></strong>".</p>
            <?php endif; ?>
         </div>
      </section>
   </main>
      ...
      <div class="modal-box">
         ...
         <div class="image-carousel">
            <div class="carousel-images">
               ...
               <?php else: ?>
               <div class="carousel-image carousel-image-empty"><i class="fas fa-water"></i></div>
               <?php endif; ?>
